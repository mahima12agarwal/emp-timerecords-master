 ...
 */
@Document
public class TimerecordLineItem {
	@Field
	public String date;
	@Field
	...
	public TimerecordLineItem(String date, Integer hours, String chargeCode, String location) {
		this.date = date;
		this.hours = hours;
		this.chargeCode = chargeCode;
		this.location = location;
	}
	public TimerecordLineItem() {
	}
	/**
	 * @return the date
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TimerecordLineItem other = (TimerecordLineItem) obj;
		if (chargeCode == null) {
